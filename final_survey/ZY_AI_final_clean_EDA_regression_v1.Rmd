...
```{r, warning=FALSE}
m.6.1 <- lm(AI_attitude_change ~ AI_attitude + AI_educated, data=d2)

m.6.2 <- lm(AI_attitude_change ~ education_level + house_income + gender, data=d2)

m.6.3 <- lm(AI_attitude_change ~ AI_attitude + AI_educated 
                 + education_level + house_income + gender, data=d2)
...
stargazer(m.6.1, m.6.2, m.6.3, m.6.4, m.6.5, m.6.6,   type = "text", 
          se = list(se.m.6.1, se.m.6.2, se.m.6.3, se.m.6.4, se.m.6.5, se.m.6.6),
